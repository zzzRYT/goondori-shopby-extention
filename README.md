...
상품심사(승인대기) 목록을 한 번에 스캔해 **등록 심사**는 규칙 위반을, **수정 심사**는 변경(diff)을 자동으로 골라냅니다.

상세 사용법(스캔 흐름 · 기본 큐레이션 10종 · 규칙 추가 · 결과 카드 보기 · 경고 메시지)은 **정식 가이드** 인 [`docs/USAGE.md` → 7. 심사 탭 사용법](docs/USAGE.md#-7-심사-탭-사용법) 을 참고하세요.
